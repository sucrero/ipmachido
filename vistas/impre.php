                                    ...
                                    <form class="form-horizontal" id="formdpto" name="formdpto" action="Operaciones.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>Fecha de Datos</label>
                                             <div class="col-xs-3 input-group date" id="sandbox-container">
                                                 <input type="text" id="fecha" class="form-control" data-date-end-date="30d" data-provide="datepicker"><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
